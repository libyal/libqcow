                  ...
                  const system_character_t *options_string )
{
	...
	static char *function              = "qcowtools_getopt";
 ...
 */
void qcowtools_getopt_wrapped_fprint(
      FILE *stream,
 ...
 */
void qcowtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const qcowtools_option_t *options,
      int number_of_options )
{
	const qcowtools_option_t *option   = NULL;
	...
	if( description != NULL )
	{
		...
		qcowtools_getopt_wrapped_fprint(
		 stream,
		 maximum_line_length,
		 0,
		 "",
 ...
 */
int qcowtools_getopt_get_options_string(
     const qcowtools_option_t *options,
     int number_of_options,
