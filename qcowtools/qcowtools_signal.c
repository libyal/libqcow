...
void (*qcowtools_signal_signal_handler)( qcowtools_signal_t ) = NULL;
             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( qcowtools_signal_signal_handler != NULL )
			{
				qcowtools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "qcowtools_signal_attach";
...
#if defined( _MSC_VER )
	qcowtools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	qcowtools_signal_signal_handler = NULL;
