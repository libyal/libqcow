...
PyTypeObject pyqcow_encryption_types_type_object = {
	...
	/* tp_basicsize */
	sizeof( pyqcow_encryption_types_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyqcow_encryption_types_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyqcow_encryption_types_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
PyObject *pyqcow_encryption_types_new(
           void )
{
	pyqcow_encryption_types_t *pyqcow_encryption_types = NULL;
	static char *function                              = "pyqcow_encryption_types_new";

	pyqcow_encryption_types = PyObject_New(
	                           struct pyqcow_encryption_types,
	                           &pyqcow_encryption_types_type_object );
	...
	if( pyqcow_encryption_types_init(
	     pyqcow_encryption_types ) != 0 )
	{
		PyErr_Format(
		 PyExc_MemoryError,
		 "%s: unable to initialize encryption types.",
	...
	return( (PyObject *) pyqcow_encryption_types );
...
{
	static char *function = "pyqcow_encryption_types_init";
