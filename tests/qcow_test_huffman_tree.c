...
uint8_t qcow_test_huffman_tree_data[ 2627 ] = {
...
/* Tests the libqcow_huffman_tree_initialize function
 * Returns 1 if successful or 0 if not
 */
int qcow_test_huffman_tree_initialize(
     void )
{
	libcerror_error_t *error             = NULL;
	libqcow_huffman_tree_t *huffman_tree = NULL;
	int result                           = 0;
	...
	huffman_tree = (libqcow_huffman_tree_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libqcow_huffman_tree_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libqcow_huffman_tree_initialize with memset failing
		 */
...
/* Tests the libqcow_huffman_tree_free function
 * Returns 1 if successful or 0 if not
 */
int qcow_test_huffman_tree_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libqcow_huffman_tree_build function
 * Returns 1 if successful or 0 if not
 */
int qcow_test_huffman_tree_build(
     void )
{
	...
	/* Test regular cases
	 */
	result = libqcow_huffman_tree_build(
	          huffman_tree,
	          code_size_array,
	          288,
	          &error );
	...
	/* Test libqcow_huffman_tree_build with malloc failing
	 */
	...
	/* Test libqcow_huffman_tree_build with memset failing
	 */
...
/* Tests the libqcow_huffman_tree_get_symbol_from_bit_stream function
 * Returns 1 if successful or 0 if not
 */
int qcow_test_huffman_tree_get_symbol_from_bit_stream(
     void )
{
	uint8_t code_size_array[ 318 ];
	...
	result = libqcow_huffman_tree_get_symbol_from_bit_stream(
	          huffman_tree,
	          bit_stream,
	          &symbol,
	          &error );
...
#endif
{
	...
	QCOW_TEST_RUN(
	 "libqcow_huffman_tree_initialize",
	 qcow_test_huffman_tree_initialize );

	QCOW_TEST_RUN(
	 "libqcow_huffman_tree_free",
	 qcow_test_huffman_tree_free );

	QCOW_TEST_RUN(
	 "libqcow_huffman_tree_build",
	 qcow_test_huffman_tree_build );

	QCOW_TEST_RUN(
	 "libqcow_huffman_tree_get_symbol_from_bit_stream",
	 qcow_test_huffman_tree_get_symbol_from_bit_stream );
