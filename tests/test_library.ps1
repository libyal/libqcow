...
$LibraryTests = "cluster_block cluster_table deflate error io_handle notify"
...
Function RunTest
{
	...
	$TestExecutable = "${TestExecutablesDirectory}\qcow_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libqcow"
