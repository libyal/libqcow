...
#if !defined( _QCOW_TEST_GETOPT_H )
#define _QCOW_TEST_GETOPT_H
...
#define qcow_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t qcow_test_getopt(
                  int argument_count,
...
#endif /* !defined( _QCOW_TEST_GETOPT_H ) */
